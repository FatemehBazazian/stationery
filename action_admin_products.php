    ...
    switch ($_GET['action']) {
        case 'EDIT':
            ...
            if (mysqli_query($link, $query) === true)
                echo ("<p class='red'><b>محصول انتخاب شده با موفقيت ويرايش شد</b></p>");
            else
                echo ("<p class='red'><b>خطا در ويرايش محصول</b></p>");
        ...
        case 'DELETE':
            ...
            if (mysqli_query($link, $query) === true){
                echo ("<p class='green'><b>محصول انتخاب شده با موفقيت حذف شد</b></p>");
                unlink("img/".$pro_image);

			}
            else
                echo ("<p class='red'><b>خطا در حذف محصول</b></p>");
...
if ($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg") {
    echo "فقط پسوندهای JPG, JPEG, PNG برای پرونده مجاز هستند  <br />";
    $uploadOk = 0;
}
...
if ($uploadOk == 1) {
    ...
    if (mysqli_query($link, $query) === true)
        echo ("<p class='green'><b>کالا با موفقیت به انبار اضافه شد</b></p>");
    else
        echo ("<p class='red'><b>خطا در ثبت مشخصات کالا در انبار</b></p>");
} else
    echo ("<p class='red'><b>خطا در ثبت مشخصات کالا در انبار</b></p>");
